...
# HTML page templates (Phase 2 refactor: extracted to templates.pages)
from app.backend.templates.pages import (
    _APP_HTML as _APP_HTML,
    _JOBS_HTML as _JOBS_HTML,
    _JOB_DETAIL_HTML as _JOB_DETAIL_HTML,
    _PROFILE_HTML as _PROFILE_HTML,
    _PUBLIC_SUBMIT_HTML as _PUBLIC_SUBMIT_HTML,
    _PUBLIC_DASHBOARD_HTML as _PUBLIC_DASHBOARD_HTML,
    _ADMIN_DASHBOARD_HTML as _ADMIN_DASHBOARD_HTML,
)
